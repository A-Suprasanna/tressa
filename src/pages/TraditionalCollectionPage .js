...
const TraditionalCollectionPage = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const snapshot = await getDocs(collection(db, "TraditionalCollectionPage"));
        ...
        console.error("Error fetching traditional products:", err);
