  ...
  return createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: '/traditionals', element: <TraditionalCollectionPage /> },
        { path: '/winters', element: <WinterCollectionPage /> },
        { path: '/Casuals', element: <CasualWear /> },
        { path: '/ethnics', element: <EthnicWear /> },
        { path: '/formals', element: <FormalWear /> },
        { path: '/parties', element: <PartyWear /> },
        ...
        {
          path: "/ordersummary",
          element: <OrderSummaryPage/>, // add this route
        },
      ],
    },
  ]);
